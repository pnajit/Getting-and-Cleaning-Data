...
setwd(path.expand("~/UCI HAR Dataset"))
...
names(dtFinalActivity)<- gsub('[-()]', '', names(dtFinalActivity))
# Names after
...
write.table(dataAggr, file = "tidyData.txt",row.names = TRUE, sep = "\t")
